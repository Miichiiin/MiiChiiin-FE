...
import { AiOutlineExpandAlt, AiOutlineInfoCircle } from 'react-icons/ai'
const ChooseRoom = () => {
  return (
      ...
      <div className='max-w-5xl mx-auto'>
        <section className='border grid grid-cols-3 gap-4 px-2 py-3'>
          ...
          <div className='col-span-2'>
            <a className='text-xl hover:underline'>Vinpearl WonderWorld Phú Quốc</a>
            ...
            <a href="" className='font-bold text-blue-700 hover:text-blue-500 hover:underline'> Xem chi tiết  </a>
          </div>
        </section>
        <section className='grid grid-cols-3 gap-4 py-3'>
            ...
            <form className='choice-column'>
              <section className='border rounded-lg grid grid-cols-3 gap-4 px-2 py-3 my-2'>
                ...
                <div className='col-span-2'>
                  ...
                  <p className=' text-right'> Giá công bố: <span className='font-bold text-lg'>6.200.000 vnđ</span>  </p>
                  <p className=' flex justify-end items-center'><AiOutlineInfoCircle /> <span className='px-2'> Giá thành viên:</span> <span className='font-bold text-xl'>5.600.000 vnđ</span>  </p>
                  <div className='justify-end flex items-center'>
                    <button className='flex border px-8 py-3 mt-4 bg-yellow-500 hover:bg-yellow-700 text-white rounded-full'>
                      Chọn
                    </button>
                  </div>
                </div>
          ...
          <form className='booking-column'>
            ...
            <div className='border rounded px-2 py-4'>
              ...
              <p className='text-sm py-3'>Chủ Nhật, Th08 27, 2023
                Thứ Ba, Th08 29, 2023
                <br />
                02 Đêm</p>
                <hr className='my-4'/>
                <button className='bg-yellow-500 hover:bg-yellow-700 text-white py-3 px-2 text-lg font-bold rounded-full w-full'>Tiếp tục</button>
            </div>
          </form>
        </section>
      </div>

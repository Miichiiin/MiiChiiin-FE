...
const MyOrder = () => {
  ...
  const getStatusText = (status: any) => {
    switch (status) {
      ...
      case 1:
        return { text: "Đã Hủy", colorClass: "text-red-500", hideButton: true };
      case 2:
                          ...
                          <div className="w-[100%] mx-auto">
                            <section className="grid grid-cols-2 h-[350px]">
                              ...
                              <div className="border">
                                <h2 className="font-medium text-lg mb-2 bg-gray-400 py-2 px-3">
                                  Thông tin đặt phòng
                                </h2>
                                <div className="px-2">

...
import { useGetHotel_homeByIdQuery, useGetHotel_homesQuery } from "@/api/webapp/hotel_home";
...
const HeaderHotel = () => {
  ...
  return (
    <div>
        <header className=" ">
            <div>
                <img className="w-full relative mb-5 h-[670px]"  src="https://statics.vinpearl.com/styles/1920x1004/public/2023_03/vinholidays-fiesta-phu-quoc-banner_1679989823.jpg.webp?itok=ODH70Jom" alt="" />
                <div className={`w-full h-[130px] z-20 text-white p-4 transition duration-300 ease-in-out ${isFixed ? 'fixed top-0 left-0 duration-800 animate-slide-down bg-gray-800 pl-[120px]' : 'duration-500 '}`}>
                    <div className="xl:w-[1280px] xl:mx-auto inset-0 absolute top-0 
                        ...
                        <div className="flex items-center justify-end space-x-2 mt-6 text-white 
                         lg:text-[15px] 
                        ">
                            <span className="text-[28px] "> < AiOutlineSearch/></span> <a href="" className=" font-medium">Đăng nhập</a><AiOutlineRight/>
                        ...
                        <div className="">
                            ...
                            ">
                                <ul className="flex items-center space-x-[30px] text-[12px] text-white 
                                    ...
                                    sm:hidden
                                ">
                                    <button onClick={toggleMenuu} className="h-[40px] pb-3 "><AiOutlineMenu/></button>
                                    ...
                                    <li className="h-[40px] after-4 font-medium"><a href="">Ẩm thực</a></li>
                        ...
                        <div className={` transition-opacity z-0 lg:ml-10 absolute top-[450px] sm:ml-5 ${isFixed ? 'absolute top-[-400px] opacity-0 ' : ''}`}>
                            <h1 className="lg:text-[45px] text-white mb-5 sm:text-[30px] font-medium" style={{ textShadow: '2px 2px 4px #000' }}>{hotelData?.name}</h1>
                            <p className="text-white sm:text-[11px] lg:text-[20px] font-medium" style={{ textShadow: '2px 2px 4px #000' }}>{hotelData?.description}</p>
                        </div>
                    </div>
                </div>
            </div>

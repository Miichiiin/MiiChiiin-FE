import { AiOutlineArrowRight, AiFillWechat, AiOutlineRight, AiOutlineLeft } from "react-icons/ai";
            ...
            <div>
                ...
                <div className="">
                    <div className="flex items-center justify-between w-[1280px] mx-auto mt-[80px]">
                        ...
                        <span className="flex items-center space-x-2 text-[#f2ba50]"><Link to="/hotels/rooms/roomtypes">Xem tất cả </Link><AiOutlineArrowRight /></span>
                    </div>
                            ...
                            {data?.map((item: any) => {
                                return <>
                                    <div >
                                        ...
                                        <p className="text-[#8e9399] text-[14px] mb-3"> <TextTruncate text={item.description} maxLength={100} /></p>
                                        <span className="flex items-center space-x-2 text-[#f2ba50]"><Link to={`/hotels/rooms/detail/${item.id}`}>Xem chi tiết </Link><AiOutlineArrowRight /></span>
                                    </div>
                                </>
                            })}
                        </Slider>

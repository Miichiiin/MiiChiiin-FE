            ...
            <div className="">
                ...
                <Slider {...settings} ref={sliderRef} className="">
                    <div className="">
                        ...
                        <p className="text-[#8e9399] text-[14px] mb-3"> <TextTruncate text="Phòng Tiêu Chuẩn Giường Đôi với diện tích 25.2 - 28.5m2 được thiết kế hiện đại, tích hợp đầy đủ tiện nghi cho kỳ lưu trú của bạn. Đây là lựa chọn lý tưởng dành cho các nhóm bạn" maxLength={100} /></p>
                        <span className="flex items-center space-x-2 text-[#f2ba50]"><a href="">Xem tất cả </a><AiOutlineArrowRight/></span>
                    </div>
                    <div className="">
                        <div className=" relative overflow-hidden mb-4">

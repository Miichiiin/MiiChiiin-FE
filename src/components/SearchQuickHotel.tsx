      ...
      >
        <div className="flex items-center w-full">
            ...
            <div ref={refCalen} onClick={handleDivClick}>
              ...
              >
                ...
                >
                  ...
                  <span className="pt-2 pt-1 text-sm  text-gray-500 group-hover:text-[#e8952f]">
                    Khách sạn - Điểm đến
                  </span>
                </div>
                <ToastContainer />
          ...
          <Form.Item className="flex-grow ml-2 group">
            <AiOutlineCalendar className=" text-gray-600  absolute top-4 start-0 z-10 w-10 h-5 text-gray-500 group-hover:text-[#e8952f]" />
            <RangePicker
          ...
          <Form.Item<FieldType> className="flex-grow ml-2">
            <button className="w-[310px]">
              ...
              >
                ...
                <div onClick={handleDivClick1} className="lg:w-[163px]">
                  <div className="xl:text-[12px] xl:space-x-6 lg:space-x-3 lg:text-[13px] sm:text-[9px] text-gray-700  sm:space-x-2  ">
                    <label
                      htmlFor=""
                      className="cursor-pointer group-hover:text-[#e8952f] ml-[-35px] text-sm  text-gray-500 group-hover:text-[#e8952f]"
                    >
                      Số phòng - Số người
                    </label>
